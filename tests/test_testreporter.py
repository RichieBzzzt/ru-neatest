...
def test_add_all_failed_test_cases():
    ...
    actual_test_add_all_failed_test_cases.append(testreporter.add_testcase("test name", False))
    actual_test_add_all_failed_test_cases.append(testreporter.add_testcase("test name 2", False))
    expected_test_add_all_failed_test_cases = [{'test': 'test name', 'issuccess': 'False', 'result': 'failure'}, {'test': 'test name 2', 'issuccess': 'False', 'result': 'failure'}]
...
def test_add_all_failed_test_cases_to_string():
    ...
    actual_test_add_all_failed_test_cases_string = str(actual_test_add_all_failed_test_cases)
    assert expected_test_add_all_failed_test_cases_string == actual_test_add_all_failed_test_cases_string